...
Transaction fully matches the user's authorization

🟡 ASK

Borderline case requiring explicit human review

🔴 BLOCK

Transaction violates policy and is stopped before payment
...
Authorized purchase within all constraints

🟢 ALLOW

UNAUTHORIZED_ADDON

AI adds an unauthorized warranty/accessory

🔴 BLOCK

UNAUTHORIZED_SUBSCRIPTION

AI adds an unauthorized recurring subscription

🔴 BLOCK

OVER_LIMIT

AI proposes a purchase above the maximum

🔴 BLOCK

AGGREGATE_SPLIT

Transactions combine to exceed spending limits
...
📥 Download Agent Leash Presentation
